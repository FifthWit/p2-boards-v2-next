...
export const p2mapdata: p2map[] = 
		[
			...
			{BSP: 'sp_a2_bts6'                  , Name: 'Tube Ride',            Chapter: 5, Coop: false, BoardID: -1, DialogueFade:    ``},
			{BSP: 'sp_a2_core'                  , Name: 'Core',                 Chapter: 5, Coop: false, BoardID: 62771, DialogueFade: ``},
			{BSP: 'sp_a3_00'                    , Name: 'Long Fall',            Chapter: 6, Coop: false, BoardID: -1, DialogueFade:    ``},
			...
			{BSP: 'mp_coop_start'               , Name: 'Calibration',          Chapter: 0, Coop: true,  BoardID: -1, DialogueFade:    ``},
			{BSP: 'mp_coop_lobby_3'             , Name: 'Hub',                  Chapter: 0, Coop: true,  BoardID: -1, DialogueFade:    ``},
