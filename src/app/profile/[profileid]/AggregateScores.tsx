...
// function PointsToRankComponent({
//     points,
//     runType,
// }: PointsToRankComponentProps) {
...
//             >
//                 TOTAL {runType.toUpperCase()} POINTS: <br />
//                 <strong>{points}</strong>
//             </HoverCardTrigger>
//             <HoverCardContent style={{ color: textColor }}>
//                 Qualifies for {rank} Rank on{' '}
//                 <Link
//                     href="https://discord.gg/p2sr"
...
//     );
// }
// // code to fix because of huge migrations
...
// //             <PointsToRankComponent
// //                 points={Math.round(totalScores.SP)}
// //                 runType={ScoreType.SP}
// //             />
// //             <PointsToRankComponent
// //                 points={Math.round(totalScores.Overall)}
// //                 runType={ScoreType.Overall}
// //             />
// //             <PointsToRankComponent
// //                 points={Math.round(totalScores.MP)}
// //                 runType={ScoreType.MP}
// //             />
// //         </div>
// //     );
// // }
